...
class Center(Compositions):
    ...
    def action(self):
        blank_img = Image.new("RGB",(self.width1,self.height1))
        blank_img.paste(self.image1,(0,0))
        blank_img.paste(self.image2,((int(self.width1/2)-int(self.width2/2)),(int(self.height1/2)-int(self.height2/2))))
        blank_img.show()

        blank_img.save("center.jpg")
