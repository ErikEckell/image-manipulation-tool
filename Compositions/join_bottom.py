...
class Join_bottom(Compositions):
    ...
    def action(self):
        blank_img = Image.new("RGB",(self.maxwidth,self.height1+self.height2))
        blank_img.paste(self.image1,(0,0))
        blank_img.paste(self.image2,(0,self.height1))
        blank_img.show()

        blank_img.save("bottom.jpg")
